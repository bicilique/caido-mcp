...
Bukti ini diambil pada 2026-07-25 pukul 19:16 WIB dari revisi implementasi `8234336` (`fix: canonicalize direct MCP entrypoints`). Commit dokumentasi bukti tidak mengubah runtime yang diverifikasi.

## Versi dan Platform

- [x] Revisi `8234336`; Node `v24.18.0` `x64`; pnpm `10.28.2`; SDK Caido `0.5.0`; MCP SDK `1.29.0`.
...
- [x] Hasil aktual: unit 181/181; contract 84/84; integration 12/12; Skill 18/18; eval 18/18; docs 8/8; coverage menjalankan 306 lulus dan 1 E2E opt-in diskip.
